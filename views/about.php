        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="about__item">
                    ...
                    <p>Các chương trình quảng cáo theo ngữ cảnh đôi khi có các chính sách nghiêm ngặt cần phải tuân thủ. Hãy lấy Google làm ví dụ.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="about__item">
                    <h4>Chúng tôi làm gì?</h4>
                    <p>Trong thế hệ kỹ thuật số này, nơi thông tin có thể dễ dàng thu được trong vòng vài giây, danh thiếp vẫn giữ được tầm quan trọng của chúng.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="about__item">
                    <h4>Tại sao chọn chúng tôi?</h4>
                    <p>Một ngôi nhà hai hoặc ba tầng là cách lý tưởng để tối đa hóa mảnh đất mà ngôi nhà của chúng ta tọa lạc.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="testimonial__text">
                    ...
                    <p>“Đi chơi sau giờ làm? Mang theo máy uốn tóc butan đến văn phòng, làm nóng nó lên, tạo kiểu tóc trước khi rời văn phòng và bạn sẽ không phải quay về nhà.”</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="counter__item">
                    ...
                    <span>Chi nhánh <br />Hải Phòng</span>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="counter__item">
